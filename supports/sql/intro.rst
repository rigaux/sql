...
.. admonition::  Supports complémentaires:
    ...
    * `Vidéo sur les notions de base <https://mediaserver.cnam.fr/videos/introduction-modeles-et-langages/>`_
...
.. eqt:: sql-notions1
   ...
   #) :eqt:`I` Parce que cela permet à tout le monde d'accéder aux fichiers, et donc à la base
