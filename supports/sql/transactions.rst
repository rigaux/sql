...
.. admonition::  Supports complémentaires:
    ...
    * `Vidéo sur la notion de transaction <https://mediaserver.cnam.fr/videos/transactions/>`_ 
...
.. admonition::  Supports complémentaires:
    ...
    * `Vidéo expliquant le fonctionnement de l'application "transactions",  <https://mediaserver.cnam.fr/videos/demonstration-de-lapplication-transactions/>`_ 
...
Commencez une autre transaction à droite: il suffit de faire ``commit`` ou ``rollback``. 
...
.. admonition::  Supports complémentaires:
    ...
    * `Vidéo sur les anomalies transactionnelles <https://mediaserver.cnam.fr/videos/anomalies-transactionnelles/>`_ 
...
.. admonition::  Supports complémentaires:
   ...
   * `Vidéo sur les niveaux d'isolation <https://mediaserver.cnam.fr/videos/les-niveaux-disolation/>`_ 
