# -*- coding: utf-8 -*-
#
# CBD documentation build configuration file, created by
...
def setup(app):
    app.add_config_value('relationnel', '', True)
    app.add_config_value('calcul', '', True)
    app.add_config_value('calculTP1', '', True)
    app.add_config_value('calculTP2', '', True)
    app.add_config_value('algebre', '', True)
    app.add_config_value('algTP1', '', True)
    app.add_config_value('algTP2', '', True)
    app.add_config_value('concexos', '', True)
...
copyright = u'2002-2022, Philippe Rigaux'
...
latex_documents = [
  ('index', 'cbd-sql.tex', u'Cours de bases de données -- Modèles et langages',
...
man_pages = [
    ('index', 'cbd', u'Cours de bases de données',
     [u'Philippe Rigaux'], 1)
]
...
texinfo_documents = [
  ('index', 'CBD', u'CBD Documentation',
   u'Philippe Rigaux', 'CBD', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Cours de bases de données'
epub_author = u'Philippe Rigaux'
epub_publisher = u'Philippe Rigaux'
epub_copyright = u'2013-2019, Philippe Rigaux'

# The basename for the epub file. It defaults to the project name.
epub_basename = u'cbd-sql'
