...
Le programme prend du temps pour parcourir un curseur : \alert{que devient la base de données pendant ce temps}\,?
...
temporaire. \alert{Tant que le curseur existe, ce cliché est conservé}. 
\end{blocgauche}
\end{frame}
...
cursor CurseurGenre is select * from Genre 
...
\alert{Notez}\,: ces mises à jour deviennent visibles par ma session
\end{frame}
...
Le résultat d'une requête est défini à l'instant de l'exécution mais exploité sur une
