...
def setup(app):
    app.add_config_value('latex', '', True)
...
copyright = u'2002-2020, Philippe Rigaux'
...
latex_documents = [
  ('index', 'cbd-sys.tex', u'Cours de bases de données -- Aspects système',
...
epub_title = u'Bases de données - Aspects systèmes'
epub_author = u'Philippe Rigaux'
epub_publisher = u'Philippe Rigaux'
epub_copyright = u'2013-2018, Philippe Rigaux'

# The basename for the epub file. It defaults to the project name.
epub_basename = u'cbd-sys'
