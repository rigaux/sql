...
\end{minted}
    ...
    est voisin avec B, B est voisin avec A. Pour éviter le doubblon
...
\begin{itemize}
  \item $Competence (p,c)$ indique que la personne $p$ a la compétence $c$
  \item $OffreEmploi (o,c)$ indique que l'organisation $o$ offre un emploi pour la compétence $c$
