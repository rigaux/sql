...
\begin{enumerate}
 ...
 \item Chaque entité définit une DF de la clé vers les attributs, et chaque association plusieurs-un
     définit une DF entre les clées. Donc\,: \texttt{idOpérateur $\to$ nom} ; \texttt{idForfait $\to$ nom, prix, idOpérateur} ; \texttt{idClient $\to$
     nom, prénom, ville, numéro, durée, idForfait}
 \item
