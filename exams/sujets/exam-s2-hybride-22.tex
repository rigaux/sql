...
{Examen seconde session 30 août 2022}%
...
% 1 pts
  \item Donnez les pièces dont aucun carton n'a pour destination le salon.
% 1 pts
...
and c.noPièceDestination = p.noPièce
...
Réécrire la requête suivante sans négation et sans disjonction.
