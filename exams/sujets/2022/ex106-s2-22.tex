...
{Examen 30 août 2022 -- session 2 -- 3h}%
{Examen en présentiel -- Documents autorisés: 10 blocs recto/verso de notes personnelles}%
...
\end{solution}
	...
	\item {\tt (2~points)} Donner le B*Tree d'ordre 2 sur \textsc{Auteur}.(IdPub, position)
