...
\vfill
 Dans notre contexte, les ``objets''  sont des \alert{valeurs élémentaires} 
 (ou \alert{atomiques}), comme 
...
Une relation de degré $n$ sur les domaines $A_1, A_2, \cdots, A_n$
    est un sous-ensemble \alert{fini} du produit cartésien  $A_1 \times A_2 \times  \cdots \times A_n$
\end{defblock}
\end{blocgauche}
\end{frame}
